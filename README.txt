...
For your convenience the KFT module comes in two flavors, one for unix based systems and one for Windows. 

Usage is as follows:

	KFT is initialized from the command line, if you don't have Python installed in your path you will have to navigate to wherever python is installed to us it.
